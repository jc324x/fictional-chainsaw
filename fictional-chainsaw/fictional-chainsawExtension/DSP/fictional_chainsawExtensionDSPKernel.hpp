//
//  fictional_chainsawExtensionDSPKernel.hpp
...
#import "fictional_chainsawExtension-Swift.h"
#import "fictional_chainsawExtensionParameterAddresses.h"

/*
 fictional_chainsawExtensionDSPKernel
 As a non-ObjC class, this is safe to use from render thread.
 */
class fictional_chainsawExtensionDSPKernel {
public:
    ...
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case fictional_chainsawExtensionParameterAddress::gain:
                mGain = value;
                break;
                // Add a case for each parameter in fictional_chainsawExtensionParameterAddresses.h
        }
    }
    ...
    void process(std::span<float const*> inputBuffers, std::span<float *> outputBuffers, AUEventSampleTime bufferStartTime, AUAudioFrameCount frameCount) {
        /*
         ...
         modify the check in [fictional_chainsawExtensionAudioUnit allocateRenderResourcesAndReturnError]
         */
