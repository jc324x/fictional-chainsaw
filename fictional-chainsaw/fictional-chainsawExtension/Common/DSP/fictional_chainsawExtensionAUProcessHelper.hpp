//
//  fictional_chainsawExtensionAUProcessHelper.hpp
...
#include <vector>
#include "fictional_chainsawExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(fictional_chainsawExtensionDSPKernel& kernel, UInt32 inputChannelCount, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    fictional_chainsawExtensionDSPKernel& mKernel;
