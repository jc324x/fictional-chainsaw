...
private let log = Logger(subsystem: "com.compozelabs.fictional-chainsawExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<fictional_chainsawExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try fictional_chainsawExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? fictional_chainsawExtensionAudioUnit else {
            log.error("Unable to create fictional_chainsawExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(fictional_chainsawExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = fictional_chainsawExtensionMainView(parameterTree: observableParameterTree)
